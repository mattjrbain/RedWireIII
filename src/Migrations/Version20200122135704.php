 ...
 */
final class Version20200122135704 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, rubrique_id INT NOT NULL, user_id INT NOT NULL, entete VARCHAR(255) NOT NULL, corps TINYTEXT NOT NULL, created_at DATETIME NOT NULL, expired_at DATETIME NOT NULL, INDEX IDX_F65593E53BD38833 (rubrique_id), INDEX IDX_F65593E5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
